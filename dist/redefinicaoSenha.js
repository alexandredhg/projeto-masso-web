const formRedefinicaoSenha = document.getElementById("formRedefinicaoSenha");
const txtSenha = document.getElementById("txtSenha");
const toggleSenhaBtn = document.getElementById('toggleSenha');
const txtConfSenha = document.getElementById("txtConfSenha");
const toggleConfSenhaBtn = document.getElementById('toggleConfSenha');
...
export {};
//# sourceMappingURL=redefinicaoSenha.js.map